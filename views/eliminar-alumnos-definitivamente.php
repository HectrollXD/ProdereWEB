...
<html lang="es">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="../images/logo.png"/>
            <title>Eliminar Alumnos Definitivamente</title>
    ...
    <body onload="ImprimirTabla()">
        ...
        <div class="container text-center" style="padding-top:100px;padding-bottom:80px;">
            <div class="row">
                ...
                <div class="col-lg-6"><h2>Eliminar alumnos definitivamente.</h2></div>
                <div class="col-lg-3"></div>
            </div>
            <hr>
            ...
            <br>
            <div class="row">
                <div class="col-lg-7 text-lg-right text-center"><label for="contra" id="rescontra">Para eliminar algún alumno es necesario confirmar la contraseña.</label></div>
        ...
        <script src="../js/eliminar-alumnos-definitivamente.js"></script>
    </body>
</html>