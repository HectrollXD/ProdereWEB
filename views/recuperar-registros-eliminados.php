...
<html lang="es">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="../images/logo.png"/>
            <title>Recuperar Registros Eliminados</title>
    ...
    <body onload="ImprimirTabla()">
        ...
        <div class="container text-center" style="padding-top:100px;padding-bottom:80px;">
            <div class="row">
                ...
                <div class="col-lg-6"><h2>Recuperar registros eliminados.</h2></div>
                <div class="col-lg-3"></div>
            </div>
            <hr>
        ...
        <script src="../js/recuperar-registros-eliminados.js"></script>
    </body>
</html>